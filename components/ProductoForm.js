...
function ProductoForm({ handleSubmitProducto }) {
    ...
    return (
        ...
        <div className="w-full ml-60 mr-2 h-min max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
